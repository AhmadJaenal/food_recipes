...
<body>
    ...
    <section class="news_section">
        <div class="container">
            ...
            @if ($substitutes['status'] == 'success')

                <div class="row justify-content-center">
                    <div class="col-md-4">
                        <ul class="list-group">
                            <li class="list-group-item disabled">Ingredient Substitutes</li>
                            @foreach ($substitutes['substitutes'] as $index => $item)
            ...
            @else
                <div class="col-12 text-center">
                    ...
                    <p class="mt-3">Data Not Available</p>
                </div>
            @endif
